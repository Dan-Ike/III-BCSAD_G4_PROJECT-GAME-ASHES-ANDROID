...
var cutscene_data = [
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f01.jpg",
		"texts": [
			"\"Commander, we await your orders\""
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f02.jpg",
		"texts": [
			"Respect and fear, are there any differences between them?"
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f03.jpg",
		"texts": [
			"..."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f04.jpg",
		"texts": [
			"\"As you command, Sir\""
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f05.jpg",
		"texts": [
			"Screams filled the area, prisoners killed, one by one."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f06.jpg",
		"texts": [
			"\"B-but sir, they’re just children!\""
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f07.jpg",
		"texts": [
			"..."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f08.jpg",
		"texts": [
			"Another fallen soldier, Silence befall."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f09.jpg",
		"texts": [
			"Respect or fear, it doesn’t matter which one."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f10.jpg",
		"texts": [
			"As long as everyone follows you."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f11.jpg",
		"texts": [
			"\"Actions has consequences, the law is above us all, even if they’re just children\""
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f12.jpg",
		"texts": [
			"Memories once again pour, this time it feels familiar."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f13.jpg",
		"texts": [
			"Yet again questions remained and not answered."
		]
	},
	{
		"background": "res://CUTSCENES - ASHES-20251012T022412Z-1-001/CUTSCENES - ASHES/4 -  memory fragment 2 (level 2.1)-20260404T080332Z-3-001/4 -  memory fragment 2 (level 2.1)/memfrag2 - f14.jpg",
		"texts": [
			"The flame seems to waver at the moment, yet did not diminish."
		]
	}
]
...
var summary_data = {
	"title": "Story Summary",
	"text": "Dante recalls being a commander feared and obeyed. He orders the execution of prisoners, even children, justifying it as law. The memory feels real, revealing his cruelty and abuse of authority, causing his resolve to momentarily waver."
}
